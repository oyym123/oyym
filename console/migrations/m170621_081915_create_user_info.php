...
class m170621_081915_create_user_info extends Migration
{
    public function safeUp()
    {
        $this->createTable('user_info', [
            ...
            'province' => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0 COMMENT "用户所在省"',
            'city' => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0 COMMENT "用户所在市"',
            'area' => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0 COMMENT "用户所在地区"',
            'app_version' => Schema::TYPE_STRING . '(25) NOT NULL DEFAULT 0 COMMENT "app版本号"',
            'phone_system' => Schema::TYPE_INTEGER . '(11) COMMENT "手机系统类型"',
